...
export function CategoriesPage() {
  const categories = [
    { id: 1, icon: 'psychology', name: 'Psicologia', desc: 'Terapia, salud mental y acompanamiento profesional verificado.', count: 'Especialistas verificados', color: 'var(--secondary)' },
    { id: 2, icon: 'medical_services', name: 'Medicina', desc: 'Atencion medica integral con cedula profesional y enfoque preventivo.', count: 'Especialistas verificados', color: 'var(--secondary)' },
    { id: 3, icon: 'self_improvement', name: 'Bienestar', desc: 'Nutricion, habitos saludables y salud integral basada en evidencia.', count: 'Especialistas verificados', color: 'var(--secondary)' },
  ];
  ...
  const handleViewChange = (mode) => {
    setViewMode(mode);
    showToast(`Vista cambiada a ${mode === 'grid' ? 'CuadrÃ­cula' : 'Lista'}`, 'info');
  };
    ...
    <>
      ...
      <section style={{ margin: '1.5rem', borderRadius: 'var(--radius-xl)', overflow: 'hidden', background: 'var(--primary)', position: 'relative', padding: '3rem 2.5rem', display: 'flex', flexWrap: 'wrap', gap: '2rem', alignItems: 'center' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, flex: 1, minWidth: '280px' }}>
          ...
          <p style={{ color: 'var(--primary-fixed-dim)', fontSize: '0.9375rem', maxWidth: '400px', marginBottom: '1.5rem', lineHeight: 1.6 }}>
            Accede a nuestro directorio de expertos verificados bajo los mÃ¡s altos estÃ¡ndares de calidad y cumplimiento profesional.
          </p>
      ...
      <section className="container" style={{ padding: '3rem 1.5rem' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '2rem', flexWrap: 'wrap', gap: '1rem' }}>
          <div>
            <h2 className="text-headline-md" style={{ color: 'var(--primary)', marginBottom: '0.25rem' }}>CategorÃ­as de Servicio</h2>
            <p style={{ color: 'var(--on-surface-variant)', fontSize: '0.875rem' }}>Especialistas verificados en Psicologia, Medicina y Bienestar.</p>
          </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.25rem' }}>
          ...
          <Link to="/directory" style={{ gridRow: 'span 2', borderRadius: 'var(--radius-xl)', overflow: 'hidden', position: 'relative', minHeight: '420px', cursor: 'pointer', display: 'block' }}>
            <img src="https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=500&h=600&fit=crop" alt="Especialistas de salud" style={{ width: '100%', height: '100%', objectFit: 'cover', position: 'absolute', inset: 0 }} />
            ...
            <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: '1.5rem', color: 'var(--on-primary)', zIndex: 1 }}>
              ...
              <h3 style={{ fontFamily: 'Manrope', fontWeight: 700, fontSize: '1.375rem', marginBottom: '0.375rem' }}>Salud verificada</h3>
              <p style={{ fontSize: '0.8125rem', color: 'var(--primary-fixed-dim)', lineHeight: 1.5, marginBottom: '1rem' }}>Psicologia, Medicina y Bienestar con validacion profesional.</p>
